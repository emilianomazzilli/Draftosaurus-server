...
<body>
  ...
  <div class="container create-game-page">
    ...
    <form id="create-game-form" class="create-form" action="../Vista/lobby.php" method="post" novalidate>
      <div class="panel pergamino">
        ...
        <div class="row private-row">
          <div class="private-left" style="align-items:center;">
            <label for="private-switch-btn" class="field-label" style="margin-right:8px;"><?= t('creategame.privateroom') ?></label>
            <!-- switch solo visual -->
        ...
        <label for="num-players" class="field-label"><?= t('creategame.nplayers') ?></label>
      ...
      <div class="form-actions">
        <button href="lobby.php" type="submit" class="btn aceptar big-aceptar"><?= t('creategame.accept') ?></button>
      </div>
    </form>
  </div>
  ...
  <div id="info-overlay" class="info-overlay" role="dialog" aria-modal="true" aria-labelledby="info-title" style="display:none;">
    <div class="info-modal pergamino">
      ...
      <h2 id="info-title"><?= t('creategame.info') ?></h2>
      <div class="info-body">
        <p><?= t('creategame.infomess') ?></p>
      </div>
    </div>
  </div>
